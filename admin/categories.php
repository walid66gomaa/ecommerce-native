    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <ul class='hidden'>
                ...
                <li>
                    <a title="EDIT" class='' href='categories.php?do=edit&cat_id=<?=$child["id"]?>'><i class='fa fa-edit'></i>
                    </a>
                    <a title="DELETE" href='categories.php?do=delete&cat_id=<?=$child["id"]?>' class=' confirm'> <i
    ...
    <form action="?do=insert" method="post" class="form-horizontal">
        ...
        <div class="form-group form-group-lg">
            ...
            <div class="col-sm-2 col-sm-offset-2">
                <input type="submit" class="btn btn-primary btn-block btn-lg" value="Add Category">
            </div>
        </div>
    ...
    <form action="?do=saveedit" method="post" class="form-horizontal">
        ...
        <div class="form-group form-group-lg">
            ...
            <div class="col-sm-10 col-md-8">
                ...
                <input type="radio" value="0" name="visibale" id="vis-no" <?php if($cat["visibility"]==0){echo
                    'checked' ;}?> >
                <label for="vis-no"> No </label>
            </div>
            <div class="col-sm-10 col-md-8">
                <input type="radio" value=1 id="vis-yes" <?php if($cat["visibility"]==1){echo 'checked' ;}?>
                name="visibale" >
                <label for="vis-yes">Yes</label>
            </div>
        </div>
        ...
        <div class="form-group form-group-lg">
            ...
            <div class="col-sm-10 col-md-8">
                ...
                <input type="radio" value="0" <?php if($cat["allowComment"]==0){echo 'checked' ;}?> name="AllowComment"
                id="com-no">
                <label for="com-no"> No </label>
            </div>
            <div class="col-sm-10 col-md-8">
                <input type="radio" value=1 id="com-yes" <?php if($cat["allowComment"]==1){echo 'checked' ;}?>
                name="AllowComment" >
                <label for="com-yes">Yes</label>
            </div>
        </div>
        ...
        <div class="form-group form-group-lg">
            ...
            <div class="col-sm-10 col-md-8">
                ...
                <input type="radio" value="0" <?php if($cat["allowAds"]==0){echo 'checked' ;}?> name="allowAd"
                id="ad-no">
                <label for="ad-no"> No </label>
            </div>
            <div class="col-sm-10 col-md-8">
                <input type="radio" value=1 id="ad-yes" <?php if($cat["allowAds"]==1){echo 'checked' ;}?>
                name="allowAd" >
                <label for="ad-yes">Yes</label>
            </div>
        </div>
        ...
        <div class="form-group form-group-lg">
            ...
            <div class="col-sm-2 col-sm-offset-2">
                <input type="submit" class="btn btn-primary btn-block btn-lg" value="Update Category">
            </div>
        </div>
